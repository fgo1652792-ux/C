...
const BASE_CATEGORIES = [
    ...
    'بناء القواعد', 'الهجرة', 'الزراعة', 'الحياة المدرسية', 'الحياة الحضرية',
    'حسم في القتل', 'حرب النجوم', 'تراجيدي', 'رياضة', 'راشد', 'خارق لطبيعية',
    'شونين', 'شريحة من الحياة', 'سينين', 'سحر', 'كوميديا', 'كوارث', 'قوى خارقة',
